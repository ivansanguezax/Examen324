...
while($datos = mysqli_fetch_array($resultado)){
    ...
    while($datos2 = mysqli_fetch_array($resultado2)){
        if($CI == $datos2["CI"]){
            echo "<td>".$datos2["nombre_Completo"]."</td>";
    ...
    echo "<td><a href='modificarIns.php?id=".$datos["id_Inscripcion"]."'>Modificar</a></td>";
    echo "<td><a href='eliminar.php?id=".$datos["id_Inscripcion"]."'>Eliminar</a></td>";
    echo "</tr>";
    $nro=$nro+1;
}
?>
