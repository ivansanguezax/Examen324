				...
				<div class="container">
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="logo-nav">
								<a href="index.php">
									<img style="width: 40px; margin-top: 10px;" src="images/logo.png" alt="Company logo" />
								</a>
							</div>
                            <!--End Logo -->
							...
							<div id="main-menu" class="collapse scroll navbar-right">
								<ul class="nav">
									...
									<a style="color:#fff; margin-left:2rem;" href="index.php" class="bordered-btn">Cerrar Sesión</a>
