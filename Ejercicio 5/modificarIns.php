...
if(isset($_GET["operacion"])){
    $sql="SELECT max(id_Inscripcion) as id_Inscripcion FROM inscripcion;";
    $resultado=mysqli_query($con,$sql);
    $datos=mysqli_fetch_array($resultado);
    $id=$datos["id_Inscripcion"]+1;
    $CI="";
    $nota1="";
    $nota2="";
    $nota3="";
...
<form action="modificarInsG.php" method="POST" class="formIndex">
