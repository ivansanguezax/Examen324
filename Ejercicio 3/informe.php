...
from 
(
SELECT distinct p.departamento, count(e.id_Inscripcion) as cantidad
FROM persona p, usuario u, inscripcion e
where u.rol='ESTUDIANTE'
and u.CI = p.CI
and e.CI_estudiante = p.CI
...
where u.rol='ESTUDIANTE'
and u.CI = p.CI
and e.CI_estudiante = u.CI
group by p.departamento) as depto;");

$nro=1;
?>
<h1>Media de notas por Departamento</h1>
<table border="1px">
    <tr>
